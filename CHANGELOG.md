...
- **KoppeltaalDeleteHoldReason codesysteem + ValueSet**: gesloten redenlijst voor de noodrem (`Task.statusReason` op de KT2DeletePendingTask), met required binding en `text 0..0` — afdwingbaar PII-vrij omdat de Task domein-breed leesbaar is.
