...
- **Duur van de grace period**: de voorsteltekst noemt bewust géén concrete duur maar verwijst naar TOP-KT-028. De gedeelde briefing noemt "10 dagen (vast; SHOULD, onderbouwd afwijken MAY)", terwijl TOP-KT-028 (v0.3, besloten) en de IG-pagina "30 dagen (default; per domein aanpasbaar)" vermelden. *Voorlopig besloten (19 aug 2026): default 30 dagen, per domein aanpasbaar binnen 14–90 dagen — de briefing-waarde vervalt.*
- **Deelname/opt-in** (TOP-KT-028 discussiepunt 3): welke applicaties een delete-pending Task krijgen (elke app in het domein of expliciete opt-in) is nog open; de voorsteltekst spreekt daarom neutraal van "deelnemende applicatie". *Voorlopig besloten (19 aug 2026): automatisch — elke applicatie-instantie in het domein; de neutrale formulering blijft correct.*
- De canonieke code/het CodeSystem van de `kt2-delete-flow`-marker is inmiddels in de IG vastgelegd (`http://vzvz.nl/fhir/CodeSystem/koppeltaal-security-label`); de voorsteltekst voor TOP-KT-002 noemt de marker desondanks niet en laat de autorisatiekant bij TOP-KT-005/TOP-KT-028.
